...
export class GraphChangeNotificationDto {
  ...
  @ApiProperty({ description: 'The payload of the specific update. Content depends on the type of update (Add, Delete, Persist)', oneOf: [
    { type: 'PersistPageUpdateDto' },
    { type: 'DeletePageUpdateDto' },
    { type: 'AddKeyUpdateDto' }
  ]})
  update: Update;
}
