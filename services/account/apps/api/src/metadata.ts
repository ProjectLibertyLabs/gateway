...
export default async () => {
  const t = {
    ...
    ['../../../libs/common/src/dtos/graph.change.request.reference']: await import('../../../libs/common/src/dtos/account.change.request.reference'),
  };
  return {
    '@nestjs/swagger': {
      models: [
        ...
        [
          import('./api.controller'),
          {
            ApiController: {
              ...
              updateGraph: { type: t['../../../libs/common/src/dtos/graph.change.request.reference'].AccountChangeRepsonseDto },
              watchGraphs: {},
            },
          },
        ],
