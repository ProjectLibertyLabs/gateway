import { ProcessingUtils } from '#lib/utils/processing';
import { OnWorkerEvent, WorkerHost } from '@nestjs/bullmq';
import { Logger, OnModuleDestroy } from '@nestjs/common';
import { Job, Worker } from 'bullmq';
<<<<<<<< HEAD:services/account/apps/worker/src/BaseConsumer.ts
========
import * as ProcessingUtils from '#lib/utils/processing';
>>>>>>>> Gateway-Mono/main:services/graph/apps/worker/src/BaseConsumer.ts
