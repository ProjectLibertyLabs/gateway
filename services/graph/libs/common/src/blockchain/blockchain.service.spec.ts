...
<<<<<<<< HEAD:services/account/libs/common/src/blockchain/blockchain.service.spec.ts
      getAccountEnvironmentType: jest.fn(),
      getAccountEnvironmentConfig: jest.fn(),
========
      getGraphEnvironmentType: jest.fn(),
>>>>>>>> Gateway-Mono/main:services/graph/libs/common/src/blockchain/blockchain.service.spec.ts
